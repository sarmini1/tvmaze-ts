...
function getShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        var response, showResponses;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(BASE_API_URL + "search/shows?q=" + term)];
                case 1:
                    response = _a.sent();
                    showResponses = response.data.map(function (r) {
                        var showObj = {
                            id: r.show.id,
                            name: r.show.name,
...
function getEpisodesOfShow(id) {
    return __awaiter(this, void 0, void 0, function () {
        var response, episodeResponses;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(BASE_API_URL + "shows/" + id + "/episodes")];
                case 1:
                    response = _a.sent();
                    episodeResponses = response.data.map(function (e) {
                        var episodeObj = {
                            id: e.id,
                            name: e.name,
                            season: e.season,
                    ...
                    return [2 /*return*/, episodeResponses];
            }
        });
    });
}
